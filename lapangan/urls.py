...
urlpatterns = [
    ...
    path('api/penyedia/<int:penyedia_id>/', views.flutter_api_get_penyedia_lapangan, name='api_get_penyedia_lapangan'),
    path('api/public/', views.flutter_api_public_list_lapangan, name='api_public_list_lapangan'),
    path('api/detail/<uuid:id_lapangan>/', views.flutter_api_detail_lapangan, name='api_detail_lapangan'),

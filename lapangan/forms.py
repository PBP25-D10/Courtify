...
class LapanganForm(forms.ModelForm):
    jam_buka = forms.TimeField(
        widget=forms.TimeInput(attrs={
            'class': 'w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500',
            'type': 'time'
        })
    )
    jam_tutup = forms.TimeField(
        widget=forms.TimeInput(attrs={
            'class': 'w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus-border-blue-500',
            'type': 'time'
        })
    ...
    class Meta:
        model = Lapangan
        fields = ['nama', 'deskripsi', 'kategori', 'lokasi', 'harga_per_jam', 'foto', 'url_thumbnail', 'jam_buka', 'jam_tutup']
        widgets = {
            ...
            'url_thumbnail': forms.URLInput(attrs={
                'class': 'w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus-border-blue-500',
        ...
        labels = {
            ...
            'foto': 'Foto Lapangan',
            'url_thumbnail': 'URL Thumbnail (opsional)',
            'jam_buka': 'Jam Buka',
            'jam_tutup': 'Jam Tutup',
        }
